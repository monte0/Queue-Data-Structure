...
const int MAX_SIZE = 16;  // this is the max number of elements
...
public:    // prototypes to be used by the client
	...
	// PRAMETER: provide the element to be enqueued
	void enqueue(el_t);

	// PURPOSE: if empty, throws an exception Underflow
	// if not empty, dequeues the front element to give it back 
	// PRAMETER: provide a holder for the element dequeued (pass by ref)
	void dequeue(el_t&);
